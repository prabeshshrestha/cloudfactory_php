...
$cf = new CloudFactory();
// $line1 = $cf->createLine("Line1","Other","Test Description1");
...
$line1->setInputFormat();// :name => "Website, :required => false, :valid_type => "url"
 ...
 $station1 = $line->createStation(); //type => "(Work/Tornament/Improve) *Improve station cannot exist as first station of a line
